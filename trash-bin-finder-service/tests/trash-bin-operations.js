...
const config = require("../static/test/test-config")
const schemas = require("../static/test/schemas")
...
describe("api", () => {
    beforeAll(function (done) {
        ...
        for (schema in schemas) {
            Initrequests(host, port, schemas[schema]);
        }
    ...
    it("addTrashBin", async () => {
        ...
        let result = await client.put("/", newtrashBin)
    ...
    it("updatEemptyingDateById", async () => {
        ...
        let result = await client.post("/emptyingDateById", data)
        expect(result.status).toEqual(200)
    ...
    it("updatLocationById", async () => {
        ...
        let result = await client.post("/locationById", data)
        expect(result.status).toEqual(200)
